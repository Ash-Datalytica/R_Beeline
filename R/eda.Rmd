...
dfTrain[whichInteger] <- as.data.frame(sapply(dfTrain[whichInteger], as.factor)) 
```
Действительно, эти переменные являются флагами и всегда имеют значение 0 или 1, не имеют значений NA. оформим их как категорийные переменные.
